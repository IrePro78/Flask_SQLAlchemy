...
app.add_url_rule('/publishers', view_func=publishers.index_publishers, methods=['GET', 'POST'])
...
app.add_url_rule('/delete-user', view_func=controlers.delete_account, methods=['GET', 'POST'])
